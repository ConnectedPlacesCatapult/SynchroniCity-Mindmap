    ...
    return (
        <div id="resultWrapper">
            <div id="standardsResult" className="standardsResult row">
                ...
                <div className="col-lg-6 col-md-6 col-sm-10 offset-lg-3 offset-md-3 offset-sm-1">
                    {/* <img id="resultTop" src={require('../../images/Close_Container.svg')} /> */}
                    
                    <div className="standardsContentContainer">
                    <div id="closeStandard" onClick={() => { generateContent.closeModal(); }}>X</div>
