...
const CTA = () => (
    <div id="CTASection">
        <div className="row CTARow">
            ...
            <div id="GetInvolvedTopBoxContainer" className="col-lg-7 col-md-7 col-sm-10 offset-lg-0 offset-md-0 offset-sm-1"><img id="GetInvolvedTopBox" src={require('../../images/Top_Box_GetInvolved.png')}/>
                <div id="CTAContent">
